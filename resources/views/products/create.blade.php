...
@section('cabecera', 'Create Product')
        ...
        <form method="POST" action="{{ route('products.store') }}" class="space-y-8" enctype="multipart/form-data">
            ...
            <div class="space-y-2">
                ...
                <textarea id="descripcion"
                    ...
                    rows="3"
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-900 focus:ring-0"
                    placeholder="Describe the product...">{{ old('descripcion') }}</textarea>
                @error('descripcion')
                <x-error>{{ $message }}</x-error>
                @enderror
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <!-- Imagen por defecto o previsualización -->
                    <div class="ml-2">
                        <img id="preview"
                            src="{{ Storage::url('images/products/default.png') }}"
